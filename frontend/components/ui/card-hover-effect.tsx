...
export const CardCategory = ({
  ...
  return (
    <h4 className={cn("text-zinc-400 font-bold tracking-wide mt-2", className)}>
      {children}
    </h4>
  );
};
...
export const CardDate = () => {
  return (
    <div className="flex mt-4 text-xs font-extralight">
      <p className="text-orange-500">Michael Lubembe</p>
      <p className="ml-auto text-orange-200">2nd April 2023</p>
    </div>
  );
};
